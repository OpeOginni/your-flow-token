...
import { Button, Box, Badge, Center, ButtonGroup } from "@chakra-ui/react";
import Link from "next/link";
import UserTokensList from "../../../components/userTokensList";

import { usePathname } from "next/navigation";
import { flowConfig } from "../../../utils/flowConfig.util";
import UserNFTCollectionList from "../../../components/userCollectionsList";
          ...
          <Box p="120px">
            <div className=" flex flex-col justify-center items-center text-gWhite">
              ...
              <ButtonGroup spacing="80" paddingTop="15px">
                <Link
                  href={`/${networkType.toLocaleLowerCase()}/createFlowNFT/createCollection`}
                >
                  <Button
                    height="48px"
                    width="150px"
                ...
                <Link
                  href={`/${networkType.toLocaleLowerCase()}/createFlowNFT/createMetaCollection`}
                >
                  <Button
                    height="48px"
                    width="150px"
